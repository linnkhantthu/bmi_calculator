...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    var screenSize = [MediaQuery.of(context).size.width, MediaQuery.of(context).size.height];
    return Scaffold(
      appBar: AppBar(
        title: Text(
          "BMI CALCULATOR",
  ...
  dynamic calculate(){
    ...
    if(bmi >= 18.5 && bmi <= 24.9){
      ...
      result[1] = "You are overweight, you need to lose weight and have healthy body. Good luck!";
    }
    else if(bmi >= 30){
      result[1] = "You are a hugely obese fat, you need to lose weight and have healthy body. Good luck!";
    }
    else{
